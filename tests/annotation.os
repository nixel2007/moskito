...
Процедура ТестДолжен_ПроверитьПараматрыАннотаций() Экспорт
	...
	Ожидаем.Что(МокТаблицаМетодов[6].Параметры[1].Аннотации[2].Параметры[0].Имя).Равно("СПараметрами");
	Ожидаем.Что(МокТаблицаМетодов[6].Параметры[1].Аннотации[2].Параметры[0].Значение).Равно(3);

	Ожидаем.Что(МокТаблицаМетодов[6].Параметры[1].Аннотации[2].Параметры[1].Имя).Равно(Неопределено);
	Ожидаем.Что(МокТаблицаМетодов[6].Параметры[1].Аннотации[2].Параметры[1].Значение).Равно(4);

	Ожидаем.Что(МокТаблицаМетодов[6].Параметры[1].Аннотации[2].Параметры[2].Имя).Равно(Неопределено);
	Ожидаем.Что(МокТаблицаМетодов[6].Параметры[1].Аннотации[2].Параметры[2].Значение).Равно(5);
