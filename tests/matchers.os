...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ПроверитьМатчерСПараметрами");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьРаботуДелегата");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьРаботуVerify");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьПересечениеРаботыМетодов");
	ВсеТесты.Добавить("ТестДолжен_ПроверитьМатчерСоответствуетВыражению");
