...
Функция Мок_ЭтоМокОбъект(Объект)
	...
	Сообщить("Это мок объект? " + Объект);

	Мок_ТипОбъекта = ТипЗнч(Объект);
	Если Мок_ТипОбъекта <> Тип("Сценарий") Тогда
		Сообщить("Мок_ТипОбъекта <> Тип(""Сценарий"")");
		Возврат Ложь;
	КонецЕсли;
...
Функция Мок_ОбъектыРавны(Знач Мок_Объект1, Знач Мок_Объект2)
	...
	Сообщить("Мок_ЭтоМокОбъект(Мок_Объект1):" + Мок_ЭтоМокОбъект(Мок_Объект1));
	Сообщить("Мок_ЭтоМокОбъект(Мок_Объект2):" + Мок_ЭтоМокОбъект(Мок_Объект2));
	Сообщить("Мок_ЭтоПримитивныйТип1:" + Мок_ЭтоПримитивныйТип1);
	Сообщить("Мок_ЭтоПримитивныйТип1:" + Мок_ЭтоПримитивныйТип2);
	Если 
