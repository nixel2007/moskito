...
Процедура Мок_СохранитьВызовМетода(Знач Мок_СтруктураПараметрыПроцедуры)
	...
	// Заполним колонки
	ЗаполнитьКалонки(Мок_СтруктураПараметрыПроцедуры, Мок_ВызываемыеМетоды);
...
Процедура Мок_НачатьУстанавливатьВозвращаемоеЗначение(Знач Мок_ИмяМетода, Знач Мок_ПараметрыПроцедуры)
	...
	// Заполним колонки
	ЗаполнитьКалонки(Мок_ПараметрыПроцедуры, Мок_ВозвращаемыеЗначения);
...
Процедура ЗаполнитьКалонки(СтруктураПараметрыПроцедуры, Таблица)
