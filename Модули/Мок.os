...
Функция ПолучитьСтрокуАннотаций(ВладелецАннотации)
	...
	Если НЕ ВладелецАннотации.Аннотации = Неопределено Тогда
		МассивАннотаций = ВладелецАннотации.Аннотации.ВыгрузитьКолонку("Имя");
	КонецЕсли;	

	АннотацииСАмперсандом = Новый Массив;
	Для Каждого Аннотация Из МассивАннотаций Цикл
		АннотацииСАмперсандом.Добавить(СтрШаблон(ШаблонАннотации, Аннотация));
	КонецЦикла;
